...
public class EnemyTurret : MonoBehaviour,IAI
{
    ...
    private void ConstructBrainNode() 
    {
        ...
        Sequence shootMoveSequence = new Sequence(new List<Node> { isOnSightNode, shootingRangeNode, shootHoldNode });

        Sequence chaseNShootSequence = new Sequence(new List<Node> { isInEngageNode, shootMoveSequence });
